...
def get_subdirectories(directory):
    ...
    for item in os.listdir(directory):
        ...
        if os.path.isdir(item_path):
            ...
            subdirectories_relpath_dict[base_folder_name]=os.path.relpath(item_path,selected_folder_path)
...
class OBJECT_PT_preset_creator(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row=layout.row()
        row.prop(context.scene,'preset_analysis_folder',text='',icon='FILE_FOLDER')
