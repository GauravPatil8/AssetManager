...
#                 blender_folder, fetch_folder_name(database_connection, index))

#             if index == 2:
#                 bpy.ops.wm.save_mainfile()
#                 old_file_path = bpy.data.filepath
#                 file_name = os.path.basename(old_file_path)
#                 new_file_path = os.path.join(blender_folder, fetch_folder_name(
#                     database_connection, index), file_name)
...
#                 get_downloads_folder(), "Temp", old_folder_name)
#             new_folder_path = os.path.join(get_downloads_folder(
#             ), "Temp", fetch_folder_name(database_connection, index))
#             os.rename(old_folder_path, new_folder_path)
