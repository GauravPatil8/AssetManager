...
classes=(ENUM_PROPS_monitor_folder,ENUM_PROPS_Tags,ENUM_PROPS_Folder_name,ENUM_PROPS_delay_time,ENUM_PROPS_monitoring_type,ENUM_PROPS_folder_presets,STRING_PROPS_preset_analysis_folder,STRING_PROPS_custom_folder_name,Bool_PROPS_Change_folder_name,OBJECT_OT_Onclick_Organise,OBJECT_OT_update_foldername,OBJECT_OT_log_popup,OBJECT_OT_log,OBJECT_OT_monitor_type,OPEN_FOLDER_OT_OpenFolder,OBJECT_PT_AssetManagerUI,OBJECT_PT_preset_creator) 
